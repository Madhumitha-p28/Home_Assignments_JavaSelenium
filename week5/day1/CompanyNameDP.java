...
public class CompanyNameDP extends ProjectSpecificMethodSalesforce {
	...
	public void CreateCompanyName() throws InterruptedException {
		...
		System.out.println("Field Name with Alert Message " + "\n" + "==================================" +" \n" + eleAlertMessage.getText());
		String strMessage = eleAlertMessage.getText();

		// VERIFY THE ALERT MESSAGE
		if (strMessage.contains("Complete this field.")) {

			System.out.println("Fill in the appropriate field -  message verified");
		} else {
